            ...
            <section id="hero">
                <div className="px-4 sm:px-6 md:px-16 mb-10 sm:mb-16 md:mb-20">
                    ...
                    <div className="xl:my-auto">
                        <p className="text-3xl sm:text-5xl lg:text-6xl text-center leading-none font-extrabold text-gray-900 tracking-tight mb-8">
                            Hi, I'm Nik! 👋🏼
                        </p>
                        <p className="max-w-3xl mx-auto text-lg sm:text-2xl text-center font-medium sm:leading-10 space-y-6 text-gray-500">
                ...
                <div className="border-b border-gray-200 mx-auto md:max-w-sm md:w-auto w-1/2 mb-10 sm:mb-16 md:mb-20 mt-10 sm:mt-16 md:mt-20 pb-3"></div>
            </section>
        </div>
    );
}
